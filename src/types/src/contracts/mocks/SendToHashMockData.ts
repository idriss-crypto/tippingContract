...
export type AssetIdAmountStruct = {
  id: PromiseOrValue<BigNumberish>;
  amount: PromiseOrValue<BigNumberish>;
};

export type AssetIdAmountStructOutput = [BigNumber, BigNumber] & {
  id: BigNumber;
  amount: BigNumber;
};

export interface SendToHashMockDataInterface extends utils.Interface {
  functions: {
...
export interface SendToHashMockData extends BaseContract {
  ...
  functions: {
    ...
    getBeneficiaryMapAssetIdAmounts(
      ...
      _assetType: PromiseOrValue<BigNumberish>,
      _assetContractAddress: PromiseOrValue<string>,
      _payerAddress: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[AssetIdAmountStructOutput[]]>;
